...
// console.log(`my skoda color is ${mySkoda.color}`)
console.log(`my skoda color is ${mySkoda.getColor()}`)
...
myAudi80.break()
myAudi80.steerWheel()
myAudi80.peridocialMaintain(10000)
...
myKTM.peridocialMaintain(20000)
...
// typescript will not allow me to create instances of abtsract classes
// this is the whole point of declaring classed as abstract
// const myVehicle = new Vehicle('KTM', 950, 90, 'orange', 2018, 3000)
