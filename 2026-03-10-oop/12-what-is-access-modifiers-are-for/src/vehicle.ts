export default class Vehicle {
    ...
    engineVolume: number
    horsePower: number
    // i want to control color changing, for example, everytime color changes,
    // i want to pay the artist
    // so i turn this member into protected
    ...
    constructor (make: string, engineVolume: number, horsePower: number, color: string, model: number, priceBeforeTax: number) {
        ...
        // for private members i can only have access from within the exact same class that 
        // defined them
